...
" => Markdown section
"""""""""""""""""""""""""""""""
au BufNewFile,BufRead *.rd set syntax=mkd
au BufNewFile,BufRead *.mkd set syntax=mkd
au BufNewFile,BufRead *.md set syntax=mkd



""""""""""""""""""""""""""""""
" => Cucumber feature section
"""""""""""""""""""""""""""""""
...
"comment by zjz: noremap <leader>m :%s/\r//g<CR>
...
" doxygen setting
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
let g:DoxygenToolkit_authorName="zhoujinze, zhoujz@chinanetcenter.com"
...
"do not verify
highlight MyTagListTagScope guifg=red ctermfg=red
...
"<+AUTHOR+>
let g:tskelUserName = 'zhoujinze'

"<+EMAIL+>
let g:tskelUserEmail = 'zhoujz@chinanetcenter.com'

"<+WEBSIET>
let g:tskelUserWWW = 'www'

"<+LICENSE+>
let g:tskelLicense = 'CopyRight (c) ChinanetCenter 2014. All Rights Reserved.'
